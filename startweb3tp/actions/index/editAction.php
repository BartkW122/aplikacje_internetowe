<?php
	...
	{
        //echo $row['id'];
        if($_POST['name']==$row['user_name']||$_POST['surname']==$row['user_surname']||$_POST['email']==$row['user_email']){
                //echo $row['id'];
                $form['id']=$row['id'];
                $user_id=$form['id'];
    ...
    echo $user_id;
    $update="UPDATE users SET user_name='{$_POST['name']}',user_surname='{$_POST['surname']}',user_email='{$_POST['email']}' WHERE id='$user_id'";
    if ($db->query($update)){
