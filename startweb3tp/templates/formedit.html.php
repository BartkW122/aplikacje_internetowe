    ...
    <div class="form">
        <form action="index.php?page=index&action=edit" method="post">
            ...
            <!--<div class="mb-4">
                ...
                <input class="form-control" type="date" name="birth_date" placeholder="Data urodzenia" value="<?php if(isset($form['birth_date']) && $isError): echo $form['surname']; endif; ?>" require/>
            </div>-->       
            <div class="mb-4">
                <label class="form-label" for="email">Adres E-mail</label>
                <input id="email" class="form-control" type="email" name="email" placeholder="Adres E-mail" value="<?php if(isset($form['email']) && $isError): echo $form['email']; endif; ?>" require>
            </div>
            <div class="mb-4">
